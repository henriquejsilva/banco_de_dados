...
-- Selecionar todas as pizzas com o valor  igual ou superior a R$ 17,00
select * from pizzas where valor >= 17;
...
-- Selecionar todas as pizzas com valor diferente de 17,00
select * from pizzas where valor != 17;
select * from pizzas where valor <> 17;
...
-- Selecionar todas as pizzas com valor na faixa de R$ 17,00 a R$ 20,00
...
-- Selecionar todas pizzas com nomes que comecem com a letra E 
...
-- Selecionar todas as pizzas com nome que tenham as letras ESA
...
-- Listar todas as colunas da tabela em ordem decrescente e valor decresente 
select* from pizzas order by valor desc, nome asc;

/* restringir o número de linhas retornadas pelo comando SELECT*/
select * from pizzas order by valor desc limit 6;
